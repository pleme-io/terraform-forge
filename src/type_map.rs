...
pub fn openapi_to_go(type_info: &TypeInfo, type_override: Option<&str>) -> GoType {
    ...
    match type_info {
        ...
        TypeInfo::Enum { underlying, .. } => openapi_to_go(underlying.as_ref(), None),
        _ => GoType::String,
    }
}
